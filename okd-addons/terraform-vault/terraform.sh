...
TF_AWS_PROFILE="terraform-okd4-tfstate"
TF_STATE_KEY="terraform-okd4-tfstate/okd-addons/terraform-vault/terraform.tfstate"
TF_LOG_LEVEL=INFO
...
TF_LOG=$TF_LOG_LEVEL terraform init -upgrade

terraform plan -var="kubernetes_host=${TF_K8S_HOST}" \
